...
class Store(Base):
    ...
    store_type: Mapped[str] = mapped_column(String(32), default="unknown", server_default=text("'unknown'"), index=True)
    assignment_status: Mapped[str] = mapped_column(String(32), default="unconfigured", server_default=text("'unconfigured'"), index=True)
    assignment_source: Mapped[str | None] = mapped_column(String(64))
    assignment_confidence: Mapped[int] = mapped_column(Integer, default=0, server_default=text("0"))
...
class AreaAssignment(Base):
    ...
    __table_args__ = (UniqueConstraint("province", "city", "store_name", "store_type", name="uq_area_assignment_province_city_store_type"),)
    ...
    store_type: Mapped[str] = mapped_column(String(32), default="all", server_default=text("'all'"), index=True)
    region: Mapped[str] = mapped_column(String(128), index=True)
    owner: Mapped[str] = mapped_column(String(128), index=True)
