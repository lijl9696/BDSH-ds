...
from ..models import FieldMapping, ImportBatch, MetricValue, RawImportRow, Store, TextMetricValue
from .platform_profiles import PlatformProfile, load_platform_profile
from .store_matching import apply_store_assignment
    ...
    *,
    ...
    if store:
        ...
        if region and not store.region:
            store.region = region
        apply_store_assignment(db, platform_code=platform_code, store=store)
        return
